...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    $(function () {
        var l, t, e = $(".datatables-basic"), a = $(".dt-complex-header"), s = $(".dt-row-grouping"), n = $(".dt-multilingual"), d = (e.length && (l = e.DataTable({
